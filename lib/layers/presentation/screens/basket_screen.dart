...
import 'package:matule/layers/presentation/shared/ui/krosi_screen.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(color: BrandColors.block),
                alignment: Alignment.center,
                child: IconButton(
                  onPressed: () {},
          ...
          Expanded(
            child: GridView.count(
              ...
              children: List.generate(1, (index) => CardScreen()),
            ),
          ),
        ],
      ),
